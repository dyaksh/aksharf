...
export const metadata: Metadata = {
  title: "Akshar Foshan — Hospitality FF&E Solutions",
  description: "Akshar Foshan crafts complete hotel furniture solutions — casegoods, upholstery, lighting, mirrors, bathroom accessories — and orchestrates sourcing, QC and logistics for hospitality brands worldwide.",
